...
namespace osu.Game.Rulesets.Difficulty.Skills
{
    public abstract class ProbabilitySkill : Skill
    {
        ...
        protected virtual double TimeThresholdMinutes => 5;
        protected virtual double AttemptThreshold => 50;
        private double probabilityThreshold => 1 / AttemptThreshold;
        ...
        protected virtual double HitProbability(double skill, double difficulty)
        {
        ...
        public override double DifficultyValue()
        {
            ...
            return RootFinding.FindRootExpand(skill => probabilityOfFcAtSkill(skill, binList) - probabilityThreshold, 0, 10);
