...
namespace osu.Game.Screens.Edit.Compose.Components
{
    ...
    public partial class DragBox : CompositeDrawable, IStateful<Visibility>
    {
        ...
        {
            Box.Position = Vector2Extensions.ComponentMin(e.MouseDownPosition, e.MousePosition);
            Box.Size = Vector2Extensions.ComponentMax(e.MouseDownPosition, e.MousePosition) - Box.Position;
        }
