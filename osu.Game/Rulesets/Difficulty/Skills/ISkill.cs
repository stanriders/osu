...
namespace osu.Game.Rulesets.Difficulty.Skills
{
    ...
    public interface ISkill
    {
        ...
        /// <summary>
        /// Processes <see cref="DifficultyHitObjects"/> and calculates <see cref="ISkillAttributes"/> with relevant difficulty information to calculate <see cref="DifficultyAttributes"/>.
        /// </summary>
