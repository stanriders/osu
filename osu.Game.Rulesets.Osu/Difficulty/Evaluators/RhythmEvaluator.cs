...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators
{
    public static class RhythmEvaluator
    {
        private readonly struct Island : IEquatable<Island>
        {
            ...
            public double AverageDelta() => Deltas.Count > 0 ? Math.Max(Deltas.Average(), 25) : 0;
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current)
        {
            ...
            int historyTimeMaxAdjusted = (int)Math.Ceiling(history_time_max / 1.0);
            int historyObjectsMaxAdjusted = (int)Math.Ceiling(history_objects_max / 1.0);
